...
def banner():
 ...
 .d88b.  .88b  d88. d888888b 
.8P  Y8. 88'YbdP`88   `88'   
88    88 88  88  88    88    
88    88 88  88  88    88    
`8b  d8' 88  88  88   .88.   
 `Y88P'  YP  YP  YP Y888888P 

\033[1;32m---------------------------------------------------------
\033[1;32m  AUTHOR    : Omi  Vau
\033[1;32m  GITHUB    : DARKDEVIL
...
def mex():
    ...
    try:
        ...
        mex()
    r = requests.get('https://raw.githubusercontent.com/MrOmi156/approved.txt/main/approved.%20txt').text
    if key1 in r:
        ...
        os.system('am start https:/8801406115895?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20Omi%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
##################
